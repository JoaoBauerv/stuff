...
<a href="/crud/src/proprietario/create.php" class="nav-link px-2 text-white">
            ...
            <main class="px-3">
                ...
                if ($rowCount > 0) {
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo '<td class="">';
                        echo '<a href="/crud/src/carro/show.php?id=' . $row["id"] . '" class="btn btn-sm btn-primary" style="margin-right: 5px;">Carros</a>';
                        echo '<a href="edit.php?id=' . $row["id"] . '" class="btn btn-sm btn-warning" style="margin-right: 5px;">Editar</a>';
                        echo '<form action="/crud/functions/proprietario/deletar.php?id=' . $row["id"] .'" method="post" style="display:inline; ">';
